...
from PALSYN.synthesizer import GRUSynthesizer
...
MODEL_DIR = TUTORIAL_ROOT / "gru_model"
...
#    - model: training hyperparameters + GRU architecture choices.
...
loaded_model = GRUSynthesizer.load(str(MODEL_DIR))
...
xes_filename = TUTORIAL_ROOT / "road_fines_gru_e=15.xes"
...
synthetic_event_df.to_excel(TUTORIAL_ROOT / "road_fines_gru_e=15.xlsx", index=False)
