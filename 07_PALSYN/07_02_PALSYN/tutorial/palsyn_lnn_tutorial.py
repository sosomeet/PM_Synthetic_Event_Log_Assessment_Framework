...
from PALSYN.synthesizer import LNNSynthesizer
...
MODEL_DIR = TUTORIAL_ROOT / "lnn_model"
...
#    - model: training hyperparameters + Liquid NN architecture choices.
...
loaded_model = LNNSynthesizer.load(str(MODEL_DIR))
...
xes_filename = TUTORIAL_ROOT / "road_fines_lnn_e=15.xes"
...
synthetic_event_df.to_excel(TUTORIAL_ROOT / "road_fines_lnn_e=15.xlsx", index=False)
