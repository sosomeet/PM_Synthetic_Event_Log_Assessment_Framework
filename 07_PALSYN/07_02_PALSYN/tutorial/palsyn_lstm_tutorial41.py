...
LOG_PATH = Path("example_logs/mimicel.xes")
TUTORIAL_ROOT = Path("tutorial")
MODEL_DIR = TUTORIAL_ROOT / "lstm_model"
...
xes_filename = TUTORIAL_ROOT / "palsyn41.xes"
...
synthetic_event_df.to_excel(TUTORIAL_ROOT / "palsyn41.xlsx", index=False)
