...
from PALSYN.synthesizer import RNNSynthesizer
...
MODEL_DIR = TUTORIAL_ROOT / "rnn_model"
...
#    - model: training hyperparameters + RNN architecture choices.
...
loaded_model = RNNSynthesizer.load(str(MODEL_DIR))
...
xes_filename = TUTORIAL_ROOT / "road_fines_rnn_e=15.xes"
...
synthetic_event_df.to_excel(TUTORIAL_ROOT / "road_fines_rnn_e=15.xlsx", index=False)
