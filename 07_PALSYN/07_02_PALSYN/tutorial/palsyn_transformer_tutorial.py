...
from PALSYN.synthesizer import TransformerSynthesizer
...
MODEL_DIR = TUTORIAL_ROOT / "transformer_model"
...
#    - model: training hyperparameters + Transformer architecture choices.
...
loaded_model = TransformerSynthesizer.load(str(MODEL_DIR))
...
xes_filename = TUTORIAL_ROOT / "road_fines_transformer_e=15.xes"
...
synthetic_event_df.to_excel(TUTORIAL_ROOT / "road_fines_transformer_e=15.xlsx", index=False)
